...
st.markdown("""
El **método de la secante** es un procedimiento iterativo para encontrar mínimos locales que utiliza aproximaciones numéricas de la derivada primera de la función. 

A diferencia del método de Newton-Raphson, no requiere el cálculo explícito de la segunda derivada, sino que estima la pendiente mediante diferencias entre puntos sucesivos. 

Esto lo hace útil cuando la segunda derivada es difícil de obtener o calcular. El método converge rápidamente si el punto inicial está cerca del mínimo, pero puede ser inestable si no se eligen adecuadamente los valores iniciales.
""")
